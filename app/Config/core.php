 ...
 *
 */
Configure::write('Routing.prefixes', array('admin','tutoriel'));
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfsgffgtr2guVniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309fdgderhjki3542496749683645');
