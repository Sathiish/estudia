...
<div id="breadcrumbs">
	<?php echo $this->Html->link("Gérer mes quiz", array("controller" => "quiz", "action" => "manager"), array("title" => "Voir tous mes quiz"));?>
            >> <?php echo $this->Html->link(strip_tags($info['Quiz']['name']), array("controller" => "questions", "action" => "edit", $info['Quiz']['id']), array("title" => "Quiz"));?><br />
            >> <?php echo $this->Html->link(strip_tags($info['Question']['question']), array("controller" => "answers", "action" => "edit", $info['Question']['id']), array("title" => "Question")); ?>
            >> Créer une nouvelle réponse

</div>

<?php echo $this->Form->create('Answer', array('action' => 'add')); ?>
<?php echo $this->Form->input('name', array('label' => "Réponse:"));?>
<?php echo $this->Form->input('question_id', array('type' => "hidden", "value" => "$questionId"));?>
<?php //echo $this->Form->input('hint', array('label' => "Indice :"));?>
...
<?php echo $this->Form->end('Ajouter cette réponse'); ?>