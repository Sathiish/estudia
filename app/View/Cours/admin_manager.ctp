...
<span class="etat action"><?php echo $this->Html->link('En attente de publication', array('controller' => 'cours', 'action'=> 'manager', "nonpublic","enattente")); ?></span>
<span class="etat action"><?php echo $this->Html->link('En attente de dépublication', array('controller' => 'cours', 'action'=> 'manager', "public","enattente")); ?></span>
<span class="etat action"><?php echo $this->Html->link('Publié', array('controller' => 'cours', 'action'=> 'manager', "public")); ?></span>
<span class="etat action"><?php echo $this->Html->link('Non-Publié', array('controller' => 'cours', 'action'=> 'manager', "nonpublic")); ?></span>
