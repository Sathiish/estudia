...
<div style="padding: 0; width: 530px; border: 1px solid #009EE0;-moz-border-radius: 10px;-webkit-border-radius: 10px; border-radius: 10px; font: Verdana, Helvetica, Arial, sans-serif;">
    ...
    <div style="margin:0 0 5px 0; background-color: #009EE0; -moz-border-radius: 10px 10px 0 0;-webkit-border-radius: 10px 10px 0 0; border-radius: 10px 10px 0 0;">
        <span style="padding: 2px 10px; font-size:16px; color: #fff; font-weight: bolder">ZeSchool</span>
    </div>

    <div style="padding: 15px;font-size:12px; color: #000; ">
        <?php echo $content_for_layout; ?>
    </div>
    
    <hr style="margin: 0 0 0 10px; border: 1px solid #009EE0;width: 510px;" />  
        
    <div style="font-size:11px; color: grey; padding: 5px 10px;">
        
        <p>Ce message est un mail automatique, merci de ne pas y
        répondre. Vous recevez ce message car vous êtes membre de ZeSchool.</p>

        <p>Nous vous rappelons que vous disposez, sur simple demande
