...
<h1>Créer un topic <?php echo $ForumActive['Forum']['name'];?></h1>

<?php $user_id = $_SESSION['Auth']['User']['id']; ?>
<?php echo $this->Form->create('Topic', array('controller' => 'topics', 'action' => 'admin_edit')); ?>
<?php echo $this->Form->input('id'); ?>
<?php echo $this->Form->input('name', array('label' => "Titre du topic:"));?>
...
<?php echo $this->Form->end('Enregistrer ce topic'); ?>
